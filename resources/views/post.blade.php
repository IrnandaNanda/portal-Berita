<x-layout :title="$title">
    {{-- <article class="py-8 max-w-screen-md">
            ...
            <div class="text-base text-gray-500">
                <a href="/authors/{{ $post->author->username }}">{{ $post->author->name }}</a> | 25 Januari 2025
            </div>
            <p class="my-4 font-light">{{ $post['body'] }}
            </p>
            <a href="/posts" class="font-medium text-blue-500 hover:underline">&laquo; Back To Home</a>
        </article> --}}
    ...
    <main class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900 antialiased">
        <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
            <article
                ...
                <a href="/posts" class="font-medium text-ms text-blue-500 hover:underline">&laquo; Back To Home</a>
